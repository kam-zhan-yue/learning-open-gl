...
void renderRectangle_2(Shader &shader, unsigned int VAO, std::array<unsigned int, 2> textures, float mixAmount);
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    renderRectangle_2(shader, VAO, textures, mixAmount);
...
void renderRectangle(Shader &shader ,unsigned int VAO, std::array<unsigned int, 2> textures, float mixAmount) {
  ...
  // manual setting of uniform mat4
...
void renderRectangle_2(Shader &shader ,unsigned int VAO, std::array<unsigned int, 2> textures, float mixAmount) {
  ...
  float scaleValue = sin(glfwGetTime()) * 2.0f;
