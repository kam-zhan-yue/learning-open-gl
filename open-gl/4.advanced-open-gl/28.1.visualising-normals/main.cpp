...
int main() {
  ...
  Shader debugShader = Shader(
    (string(SHADER_DIR) + "/debug-vertex.glsl").c_str(), 
    (string(SHADER_DIR) + "/debug-geometry.glsl").c_str(), 
    (string(SHADER_DIR) + "/debug-fragment.glsl").c_str()
  );
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    renderModel(backpack, debugShader);
